...
class _StudentProfileState extends State<StudentProfile> {
  Future<void> readData(StudentUser userVar) async {
    final data = await supabase
        .from('Students')
        .select('''*''').match({'id': userVar.userID});
    return data;
  }
          ...
          children: [
            ...
            ListTile(
              ...
              title: InkWell(
                onTap: () async {
                  try {
                    await launchUrlString(data[0]['resumeLink'].toString());
                  } catch (err) {
            ...
            Card(
              ...
              child: Column(
                children: [
                  ...
                  const Divider(),
                  DisplayGrade(sem: "I", score: (data[0]['SPI1'].toString())),
                  DisplayGrade(sem: "II", score: (data[0]['SPI2'].toString())),
                  DisplayGrade(sem: "III", score: (data[0]['SPI3'].toString())),
                  DisplayGrade(sem: "IV", score: (data[0]['SPI4'].toString())),
                  DisplayGrade(sem: "V", score: (data[0]['SPI5'].toString())),
                  DisplayGrade(sem: "VI", score: (data[0]['SPI6'].toString())),
                  DisplayGrade(sem: "VII", score: (data[0]['SPI7'].toString())),
                  DisplayGrade(
